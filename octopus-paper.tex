...
The genotype posterior probability distributions computed in the previous step are used to compute physical phasing of called variant sites. No read data is required as all information available from the read data as well as any prior information is contained in the posterior distributions.
