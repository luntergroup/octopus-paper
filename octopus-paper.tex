...
Our groups previous work has shown it is possible to genotype HLA loci with high accuracy using HTS \cite{RN5}. An important step in HLA genotyping is the construction of putative haplotypes by phasing local variation. Due to octopus' capability to construct long haplotypes, we reasoned it could offer better HLA genotyping than other methods.
